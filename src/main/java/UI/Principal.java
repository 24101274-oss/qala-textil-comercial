...
public class Principal extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/logo.png"))); // NOI18N

        title.setText("Bienvenido");

        jLabel2.setText("Sistema de Gestión de Inventario para Qala Textil S.A.C. Controle y administre de forma óptima y");

        jLabel3.setText("fácil el flujo de inventario, producción y almacén.");

        jLabel4.setText("Esta herramienta le permitirá llevar un control completo y detallado de su empresa textil");

        jLabel5.setText("tendrá acceso a herramientas especiales para tareas específicas, como lo son:");

        jLabel6.setText("• Control de Inventario (Telas, hilos, prendas terminadas)");

        jLabel7.setText("• Gestión de Órdenes de Producción");

        jLabel8.setText("• Registro de Nuevos Artículos y Proveedores");

        jLabel9.setText("• Edición de Insumos y Productos Existentes");

        jLabel10.setText("• Eliminación de Registros del Sistema");

        jLabel11.setText("• Sección de Reportes de Movimientos y Ventas");
